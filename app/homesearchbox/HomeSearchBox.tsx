...
import SearchButtonHome from "@/app/homesearchbox/components/SearchButtonHome";
const HomeSearchBox = () => {
  const tabStyle =
    "min-w-[120px] p-[20px] flex flex-row items-center cursor-pointer grayscale data-[state=active]:grayscale-0 data-[state=active]:text-[#00026E] text-[16px] font-[Gilroy-Bold] border-b-[2px] border-b-[#fff] data-[state=active]:border-b-[2px] data-[state=active]:border-b-[#fdcc02]";
  return (
    <>
